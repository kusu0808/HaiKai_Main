...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (IsJumpEnabled) JumpAndGravity();
            if (IsJumpEnabled) GroundedCheck();
            if (IsMoveEnabled) Move();
        }

        private void LateUpdate()
        {
            if (IsLookEnabled) CameraRotation();
        }
        ...
        private void Move()
        {
            ...
            float targetSpeed = (IsSprintEnabled && _input.sprint) ? SprintSpeed : MoveSpeed;
