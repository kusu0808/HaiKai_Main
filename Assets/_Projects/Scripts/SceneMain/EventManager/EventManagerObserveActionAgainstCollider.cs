    ...
    public sealed partial class EventManager
    {
        ...
        private async UniTaskVoid ObserveActionAgainstCollider(CancellationToken ct)
        {
            ...
            Action GetEvent(string tag, CancellationToken ctIfNeeded) => tag switch
            {
                ...
                "ActionAgainstCollider/Event/BigIvyOnPathWay" => () => GeneralCutBigIvy(IvyType.PathWay, ctIfNeeded),
                ...
                "ActionAgainstCollider/Event/Cup" => () => WarehousePickUpCup(),
                ...
                "ActionAgainstCollider/Event/DoorPuzzleSolvingFinalKey2RightDoorKnob" => () => CaveOpenFinalKey2Door(FinalKey2DoorType.Right, ctIfNeeded),
                "ActionAgainstCollider/Event/DoorPuzzleSolvingFinalKey2LeftDoorKnob" => () => CaveOpenFinalKey2Door(FinalKey2DoorType.Left, ctIfNeeded),
